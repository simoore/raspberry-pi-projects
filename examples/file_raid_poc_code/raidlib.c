...
int stripeFile(char *inputFileName, int offsetSectors)
{
    ...
    do
    {
        ...
        //
        xorLBA(PTR_CAST & stripe[0], PTR_CAST & stripe[512], PTR_CAST & stripe[1024], PTR_CAST & stripe[1536],
...
int restoreFile(char *outputFileName, int offsetSectors, int fileLength, int missingChunk)
{
    ...
    for (idx = 0; idx < stripeCnt; idx++)
    {
        ...
        if (missingChunk == 1)
        {
            rebuildLBA(PTR_CAST & stripe[512], PTR_CAST & stripe[1024], PTR_CAST & stripe[1536],
                PTR_CAST & stripe[2048], PTR_CAST & stripe[0]);
        }

        if (missingChunk == 2)
        {
            rebuildLBA(PTR_CAST & stripe[0], PTR_CAST & stripe[1024], PTR_CAST & stripe[1536], PTR_CAST & stripe[2048],
                PTR_CAST & stripe[512]);
        }
        if (missingChunk == 3)
        {
            rebuildLBA(PTR_CAST & stripe[0], PTR_CAST & stripe[512], PTR_CAST & stripe[1536], PTR_CAST & stripe[2048],
                PTR_CAST & stripe[1024]);
        }
        if (missingChunk == 4)
        {
            rebuildLBA(PTR_CAST & stripe[0], PTR_CAST & stripe[512], PTR_CAST & stripe[1024], PTR_CAST & stripe[2048],
                PTR_CAST & stripe[1536]);
        }
        if (missingChunk == 5)
        {
            rebuildLBA(PTR_CAST & stripe[0], PTR_CAST & stripe[512], PTR_CAST & stripe[1024], PTR_CAST & stripe[1536],
                PTR_CAST & stripe[2048]);
        }
